...
map('', '<Leader>d', '<Cmd>lua vim.diagnostic.open_float(nil, {focusable = true, scope = \'line\', close_events = {"CursorMoved", "CursorMovedI", "BufHidden", "InsertCharPre", "WinLeave"}})<CR>', {silent = true})
